...
\begin{ritemize}
    ...
    \ritem Developed \textit{NUTS: Neural Unit Test Suggestions} system using neural transformers and a specialized grammar to automatically generate unit tests that are highly effective at finding bugs ($170\%$ improvement over any other evaluated system). Available as Arxiv preprint.
\end{ritemize}
...
\begin{itemize}[label={},itemindent=-2em,leftmargin=2em, parsep=4pt]
  \item {\bf [Arxiv preprint 2021]} \textrm{\fontsize{11pt}{12pt}\selectfont NUTS: Neural Unit Test Suggestions.} E. Dinella, G. Ryan, T. Mytkowitz, S. Lahiri. \url{https://arxiv.org/pdf/2109.09262.pdf}
  ...
  \item {\bf [PLDI 2020]} \textrm{\fontsize{11pt}{12pt}\selectfont Learning Nonlinear Loop Invariants with Gated Continuous Logic Networks} Y. Jianan, G. Ryan, J. Wong, S. Jana, and R. Gu. \url{https://arxiv.org/abs/2003.07959}
