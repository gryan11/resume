...
\begin{ritemize}
    ...
    \ritem Developing new methods for testing concurrent programs using probabilistic learning and specialized transformer architectures.
...
\begin{ritemize}
    ...
    \ritem Developed \textit{TOGA: A Neural Method for Test Oracle Generation} using neural transformers and a specialized grammar to generate unit tests. Published in ICSE 2022, awarded ACM SigSoft Distinguished Paper Award.
\end{ritemize}
...
\begin{ritemize}
\ritem Developed a framework for 3d Simultaneous Localization and Mapping using the Lidar Odometry and Mapping algorthim. Modified algorithm to integrate IMU Sensor data using an Extended Kalman Filter. Implemented in C++ with PCL and ROS.
\end{ritemize}
