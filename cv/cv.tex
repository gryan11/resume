...
\begin{ritemize}
    ...
    \ritem Exploring applications of Transformers and Probabalistic Models to guide test generation and API fuzzing advised by Prof. Suman Jana.
...
\begin{ritemize}
    ...
    \ritem Developed \textit{TOGA: A Neural Method for Test Oracle Generation} using neural transformers and a specialized grammar to automatically generate unit tests that are highly effective at finding bugs ($170\%$ improvement over any other evaluated system). Published in ICSE 2022, awarded ACM SigSoft Distinuished Paper Award.
\end{ritemize}
