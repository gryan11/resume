...
\vspace{0.1cm}
  ...
  %{\normalsize
  %\texttt{
    \url{gabe@cs.columbia.edu} | \url{www.cs.columbia.edu/~gabe}
    %}
  }
...
\begin{ritemize}
\ritem Ph.D. Candidate in Computer Science with research focus on deep learning for program analysis
...
\begin{ritemize}
    ...
    \ritem Developed \textit{TOGA: A Neural Method for Test Oracle Generation} using neural transformers and a specialized grammar to automatically generate unit tests that are highly effective at finding bugs ($170\%$ improvement over any other evaluated system). Published in ICSE 2022.
\end{ritemize}
...
\begin{ritemize}
    ...
    \ritem Exploring applications of Transformers and Graphical Neural Networks to guide test generation and API fuzzing advised by Prof. Suman Jana.
    \ritem Designed the \textit{Continuous Logic Network} (CLN), a new neural architecture that directly models logic with SMT, and led a team of 3 students to implement a new loop invariant inference system (CLN2INV), that is the first to solve all 124 theoretically solvable loop invariant inference problems in the Code2Inv dataset. Published in ICLR 2020, with follow up work in PLDI 2020. 
  \ritem Developed \textit{Proximal Gradient Analysis} (PGA), a new method for dynamic software analysis that uses nonsmooth optimization methods to approximate gradients over a program. Implemented PGA as an LLVM pass and demonstrated it improved f1 accuracy by 33\% over current methods in measuring dataflows to branches. Published in Usenix Security 2021.
\end{ritemize}
...
\begin{itemize}[label={},itemindent=-2em,leftmargin=2em, parsep=4pt]
  \item {\bf [ICSE 2022]} \textrm{\fontsize{11pt}{12pt}\selectfont TOGA: A Neural Method for Test Oracle Generation.} E. Dinella*, G. Ryan*, T. Mytkowitz, S. Lahiri. \url{https://arxiv.org/pdf/2109.09262.pdf}
  \item {\bf [OSDI 2021]} \textrm{\fontsize{11pt}{12pt}\selectfont DistAI: Data-Driven Automated Invariant Learning for Distributed Protocols} J. Yao, R. Tao, R. Gu, J. Nieh, S. Jana, G. Ryan. \url{https://www.usenix.org/system/files/osdi21-yao.pdf}
  \item {\bf [USENIX Security 2021]} \textrm{\fontsize{11pt}{12pt}\selectfont Fine Grained Dataflow Tracking with Proximal Gradients.} G. Ryan, A. Shah, D. She, K. Bhat, and S. Jana. \url{https://arxiv.org/abs/1909.03461}
  \item {\bf [PLDI 2020]} \textrm{\fontsize{11pt}{12pt}\selectfont Learning Nonlinear Loop Invariants with Gated Continuous Logic Networks} J. Yao*, G. Ryan*, J. Wong*, S. Jana, and R. Gu. \url{https://arxiv.org/abs/2003.07959}
  \item {\bf [ICLR 2020]} \textrm{\fontsize{11pt}{12pt}\selectfont CLN2INV: Learning Loop Invariants with Continuous Logic Networks.} G. Ryan*, J. Wong*, Y. Jianan*, R. Gu, and S. Jana. \url{https://arxiv.org/abs/1909.11542}
  \item {\bf [InfoVis 2018]} \textrm{\fontsize{11pt}{12pt}\selectfont At a Glance: Pixel Approximate Entropy as a Measure of Line Chart Complexity.} G. Ryan, A. Mosca, R. Chang, and E. Wu. \url{https://arxiv.org/abs/1811.03180}
  \item  {\bf [Oakland S\&P Workshops 2018]} \textrm{\fontsize{11pt}{12pt}\selectfont Simulated User Bots: Real Time Testing of Insider Threat Detection Systems.} P. Dutta, G. Ryan, A. Zieba, and S. Stolfo. \url{https://ieeexplore.ieee.org/document/8424654}
...
\hspace*{-0.3cm}
\textbf{Languages:} Proficient in C/C++, Java, Javascript, Python, and SQL. \\
\hspace*{-0.3cm}
\textbf{Technologies:} Linux, Cloud Compute, Pytorch, Tensorflow, LLVM, Qemu, Z3
