...
I'm interested in how far agents can be pushed on real software engineering tasks, particularly through improvements in post-training and harness design for long horizon tasks.
\end{minipage}
\vspace{0.15cm}
