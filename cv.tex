...
I'm interested in post-training and harness design for building more capable agents across software engineering and related domains that require complex reasoning and long-term planning.
...
\begin{ritemize}
    \ritem Train custom models for context retrieval subagents, trajectory compaction, and memory generation using RLVR with the Slime framework and SGLang for inference, fine-tuning on production Copilot traffic to improve agentic performance and achieving a 15\% cost reduction in internal deployments.
