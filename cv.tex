...
\begin{ritemize}
    ...
    \ritem Curate code datasets for post-training, including synthetic data generation and SFT dataset construction.
    \ritem Configured and ran production A/B experiments through Microsoft's ExP platform, serving competing model variants to feed insights back into training.
\end{ritemize}
