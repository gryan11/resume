...
\begin{ritemize}
    ...
    \ritem Drove a 5\% increase in acceptance rate while reducing latency by 10\%, using OpenAI models trained on a custom code dataset filtered for quality and relevance.
\end{ritemize}
...
\begin{itemize}[label={},itemindent=-2em,leftmargin=2em, parsep=4pt]
  ...
  \item \textbf{ML \& LLMs:} PyTorch, Transformers, Hugging Face, Slime (RL framework), LLM post-training (SFT, DPO, RLHF), prompt engineering, evaluation, data curation.
