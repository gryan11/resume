...
I'm interested in improving agent performance on tasks that require complex, long horizon reasoning through post-training and agent harness design.
...
\begin{ritemize}
    \ritem Contributed to LLM-based linux kernel bug localization and repair research, including benchmark design and evaluation of LLMs on kernel bug repair tasks. 
\end{ritemize}
