...
\begin{ritemize}
    ...
    \ritem Trained the code completion models powering GitHub Copilot in editors used by millions of developers, fine-tuning on production usage data to drive a 5\% acceptance-rate increase while reducing latency by 10\%.
