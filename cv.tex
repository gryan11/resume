...
\begin{ritemize}
    \ritem Developed LLM-based linux kernel bug localization and repair research, including benchmark design and evaluation of LLMs on kernel bug repair tasks. 
\end{ritemize}
