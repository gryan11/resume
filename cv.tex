...
\vspace{0.1cm}
  {\fontsize{11}{13}\selectfont
      \href{mailto:gabriel.ryan11@gmail.com}{gabriel.ryan11@gmail.com} \ \textbar\ \href{https://linkedin.com/in/gabrielryan1}{LinkedIn} \ \textbar\ \href{https://gryan11.github.io}{Website}
  }
\end{minipage}
\vspace{-0.15cm}
...
\begin{ritemize}
    \ritem Training custom models for Copilot subagents, context compaction, and memory generation, enabling agentic workflows to delegate focused sub-tasks and operate over long horizons.
    ...
    \ritem Drove increases in code survival rates through post-training improvements to the code completion models powering GitHub Copilot.
\end{ritemize}
...
\begin{ritemize}
\ritem Built a web application for managing large-scale deployments of user-behavior sensors and data-loss detection using Java Spring, AngularJS, Hibernate, PostgreSQL, and MongoDB.
\ritem Designed and implemented a REST API (Swagger spec, OAuth 2.0) and a midstream network document interception and tracking system using Squid Proxy and ICAP.
\end{ritemize}

\rjob{\textbf{Robotics Software Consultant}, 3DDataLtd}{May 2015 -- Aug 2015}\\
\begin{ritemize}
\ritem Built a 3D SLAM framework based on Lidar Odometry and Mapping, integrating IMU sensor data via an Extended Kalman Filter.
\end{ritemize}

\rjob{\textbf{Radar Software Engineer}, Raytheon}{Sep 2013 -- Apr 2015}\\
\begin{ritemize}
\ritem Built software for radar calibration, satellite tracking, antenna diagnostics, and maintenance prioritization in Ada and C++; earned a team achievement award for delivering new diagnostic capabilities ahead of schedule.
\end{ritemize}
...
\begin{itemize}[label={},itemindent=-2em,leftmargin=2em, parsep=5pt]
  ...
  \item {\bf [ICSE 2022]}
    ...
    E. Dinella*, G. Ryan*, T. Mytkowicz, S. Lahiri. \url{https://arxiv.org/pdf/2109.09262.pdf} \textbf{(Distinguished Paper Award)}
  \item {\bf [OSDI 2021]}
...
\begin{itemize}[label={},itemindent=-2em,leftmargin=2em, parsep=4pt]
  ...
  \item \textbf{ML \& LLMs:} PyTorch, Transformers, HuggingFace, LLM post-training (SFT, DPO, RLHF), prompt engineering, evaluation, data curation.
