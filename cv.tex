...
\begin{ritemize}
    \ritem Built automated optimization loops that orchestrate specialist subagents over multi-stage experiment campaigns, applied to the Copilot code review harness (+11pp F1 review comment improvement), LLM judges for online quality metrics (-43\% error rate) and to embedding model training recipes (+10pp NDCG improvement).
